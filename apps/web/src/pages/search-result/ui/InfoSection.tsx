      ...
      <div className="flex flex-col gap-[6px] w-full">
        <div className="flex flex-col w-full bg-transparent">
          {displayPlaces.map((place) => {
            const imageSrc = place.imageUrl?.trim();
              ...
              >
                <div className="shrink-0">
                  <div className="relative h-18 w-18 overflow-hidden rounded-2xl bg-neutral-20">
                    {imageSrc ? (
                      <Image src={imageSrc} alt={place.placeName} fill className="object-cover" />
                    ) : (
                ...
                <div className="flex flex-col pl-2 min-w-0 flex-1 overflow-hidden">
                  ...
                  <p className="body-14-semibold text-neutral-50 truncate pt-0.75">
                    {place.summary}
                  </p>
