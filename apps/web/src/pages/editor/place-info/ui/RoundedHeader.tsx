...
export const RoundedHeaderSection = ({
  ...
  return (
    <section className="relative mb-[86px]">
      ...
      "
      >
        <div className="heading-20-semibold">{place?.placeName}</div>
